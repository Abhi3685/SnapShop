...
<div id="overlay">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header text-center" style="padding-bottom: 30px;">Update Product</h1>
        </div>
    </div>
    ...
    ?>
            ...
            <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="row" style="margin-bottom: 30px">
                            <div class="col-lg-12">
                                <input type="text" id="prod_id" value="<?php echo $p_id; ?>" hidden>
                                <input type="text" id="prod_title" class="form-control" name="title" value="<?php echo $p_title; ?>">
                            </div>
                        </div>

                        <div class="row" style="margin-bottom: 30px">
                            <div class="col-lg-12">
                                <input type="text" id="prod_price" value="<?php echo $p_price; ?>" class="form-control" name="price">
                            </div>
                        </div>
                            ...
                            <select class='form-control' id='categoriesSelect' style='margin-bottom: 30px;' onchange="getsubcats()">
                                <?php
                                    ...
                                    while($row = mysqli_fetch_assoc($get_categories)){
                                        ...
                                        $id = $row['cat_id'];
                                        if(strtolower($category) == strtolower($p_category)){
                            ...
                            <select class='form-control' id='subcatsSelect'>
                                <?php
                                    $query = "SELECT * FROM categories WHERE cat_id = '$p_category_id'";
                                    $category = mysqli_fetch_assoc(mysqli_query($conn, $query));
                                    $cat_sub = $category['cat_sub'];
                                    $tags = explode(",", $category['cat_sub']); 
                                    foreach($tags as $tag){  
                    ...
                    <div class="text-right" style="margin-top: 30px;">
                            <button type="button" id="update_prod_btn" name="update_prod" class="btn btn-lg btn-block btn-primary" style="padding: 10px 50px; float: left;" >Update Product</button>
                        </div>
                    </div>
                    <div class="col-md-6" >
                            ...
                            <div class='text-center'><img id='output_image' width="80%" src="<?php echo $p_img; ?>"></div>
                    </div>
      ...
      <script>
        $("#update_prod_btn").click(function(){
            ...
            if(title != '' && category != '' && price !='' && img != ''){
                $.ajax({
                    ...
                    data: { action: 'update_prod', id: id ,title: title, category: category, price: price, img: img,sub: sub },
