...
if(isset($_GET['add'],$_GET['sub'])){
    $category = $_GET['add'];
    $cat_sub = $_GET['sub'];
    $query = "INSERT INTO categories(cat_title,cat_sub) VALUES('$category','$cat_sub')";
...
<div id="overlay">
                ...
                <div class="section__content section__content--p30" style="padding-left: 0px;">
                    <div class="container-fluid">
                        ...
                        <div class="row" style="margin-bottom: 40px;">
                            ...
                            <div class="col-md-5">
                                <input class="form-control" placeholder="Sub-Category Name 1, Name 2 ..." id="subcat_name">
                            </div>
                            <div class="col-md-2">
                              ...
                              <table class="table table-hover">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td class="text-center"><?php echo $cat_sub; ?></td>
    ...
    <script>
        ...
        function add_category(){
            ...
            var sub_cat = $("#subcat_name").val();
            window.location.href='categories.php?add='+cat+'&sub='+sub_cat;
        }
    </script>
