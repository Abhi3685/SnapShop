  ...
  if(mysqli_num_rows($checkUser) == 0){
    ...
    $username = mysqli_fetch_assoc($checkUser)['username'];  
      ...
      try {
        ...
        $mail->setFrom('snapshopcustomerverify@gmail.com');
        ...
        $mail->Subject = 'SnapShop Account Password Reset';
                      ...
                      <td class='email-body' width='100%'>
                        ...
                        <table class='email-body_inner' align='center' cellpadding='0' cellspacing='0'>
                          ...
                          <td class='email-masthead'>
                            ...
                            <a class='email-masthead_name'>SnapShop Account Password</a>
                          ...
                          <tr>
                            ...
                            <td class='content-cell'>
                              ...
                              <div class='greeting-div'>
                                ...
                                <p>You recently requested password for your SnapShop account. Here is your password: </p>
